...
def train(config, generator, discriminator, kp_detector, he_estimator, checkpoint, log_dir, dataset, device_ids):
    ...
    # Set optimizers for each of the 4 models
    ...
    # We can load a checkpoint and the models at that state
    ...
    # Multistep LR is a learning rate decay scheduler
    ...
    # Aggregates the models used for generation
    ...
    # Aggregates the models used in discrimination
