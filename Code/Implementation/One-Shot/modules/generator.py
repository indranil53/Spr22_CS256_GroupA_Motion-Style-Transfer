...
class OcclusionAwareSPADEGenerator(nn.Module):
    ...
    def encode_source(self, source_image):
        ...
        bs, c, h, w = out.shape
        # print(out.shape)
        self.feature_3d = out.view(bs, self.reshape_channel, self.reshape_depth, h ,w) 
        self.feature_3d = self.resblocks_3d(self.feature_3d)
    ...
    def forward(self, source_image, kp_driving, kp_source):
        ...
        output_dict = {}
        if self.dense_motion_network is not None:
            dense_motion = self.dense_motion_network(feature=self.feature_3d, kp_driving=kp_driving,
                                                     kp_source=kp_source)
            output_dict['mask'] = dense_motion['mask']
            ...
            if 'occlusion_map' in dense_motion:
                ...
                occlusion_map = None
            deformation = dense_motion['deformation']
            out = self.deform_input(self.feature_3d, deformation)
